...
\begin{table}
    ...
    \caption{\label{tab:wfn_BE} PAs of \ce{Be} calculated using various methods. The methods and basis used as reported as "without $e^{+}$ method or basis // with $e^{+}$ method or basis". We also report if the $s^2 \rightarrow p^2$ near degeneracy is handled in the trial wave function.}
    %\begin{tabular}{lrl}
