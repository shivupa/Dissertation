...
\begin{itemize}
    \item \textbf{Density Function Theory}- Since the \glsxtrlong{hf} method neglects $e^{-}$ correlation by using an averaged potential, density functional theory attempts to modify the effection potential to recover correlation energy.
